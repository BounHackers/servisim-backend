...
RSpec.describe Api::V1::ParentsController, type: :controller do
  ...
  describe 'POST #create' do
    context 'with valid params' do
      ...
      it 'renders a JSON response with the new parent' do
        post :create, params: { parent: valid_attributes }, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(parent_url(Parent.last))
      end
    end

    context 'with invalid params' do
      it 'renders a JSON response with errors for the new parent' do
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      ...
      it 'renders a JSON response with the parent' do
        parent = Parent.create! valid_attributes
    ...
    context 'with invalid params' do
      it 'renders a JSON response with errors for the parent' do
        parent = Parent.create! valid_attributes
